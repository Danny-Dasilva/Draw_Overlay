...
_CLIENTBOUND = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='usbvid', full_name='ClientBound.usbvid', index=3,
...
_USBVID = _descriptor.Descriptor(
  name='USBVID',
  full_name='USBVID',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='data', full_name='USBVID.data', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLIENTBOUND.fields_by_name['usbvid'].message_type = _USBVID
...
_CLIENTBOUND.oneofs_by_name['message'].fields.append(
  _CLIENTBOUND.fields_by_name['usbvid'])
_CLIENTBOUND.fields_by_name['usbvid'].containing_oneof = _CLIENTBOUND.oneofs_by_name['message']
...
DESCRIPTOR.message_types_by_name['USBVID'] = _USBVID
...
USBVID = _reflection.GeneratedProtocolMessageType('USBVID', (_message.Message,), dict(
  DESCRIPTOR = _USBVID,
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:USBVID)
  ))
_sym_db.RegisterMessage(USBVID)
