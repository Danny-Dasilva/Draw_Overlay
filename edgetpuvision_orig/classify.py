...
def add_render_gen_args(parser):
    parser.add_argument('--model', required=False,
                        help='.tflite model path', default=dir_path+'/models/mobilenet_v2_1.0_224_quant_edgetpu.tflite')
    parser.add_argument('--labels', required=False,
                        help='label file path', default=dir_path + '/models/imagenet_labels.txt')
